...
resource "oci_core_capture_filter" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.capture_filters != null ? var.vtap_configuration.capture_filters : {}) : {}
...
resource "oci_network_load_balancer_network_load_balancer" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancers != null ? var.vtap_configuration.network_load_balancers : {}) : {}
  compartment_id = each.value.compartment_id != null ? each.value.compartment_id : (var.vtap_configuration.default_compartment_id != null ? var.vtap_configuration.default_compartment_id : null)
  display_name   = each.value.display_name
...
resource "oci_core_vtap" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.vtaps != null ? var.vtap_configuration.vtaps : {}) : {}
...
resource "oci_network_load_balancer_listener" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancer_listeners != null ? var.vtap_configuration.network_load_balancer_listeners : {}) : {}
...
resource "oci_network_load_balancer_backend_set" "these" {
  for_each = var.vtap_configuration != null ? (var.vtap_configuration.network_load_balancer_backend_sets != null ? var.vtap_configuration.network_load_balancer_backend_sets : {}) : {}
  health_checker {
    protocol = each.value.protocol
  }
