...
variable "default_log_group_name" {
  ...
  default     = "DEFAULT_CHILD_LOG_GROUP"
}
variable "default_log_group_desc" {
  type        = string
  description = "Default Log Group Description"
  default     = "DEFAULT_CHILD_LOG_GROUP_Description"
}
...
variable "lb_access_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-LB-ACCESS-LOG"
}
...
variable "lb_error_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-LB-ERROR-LOG"
}
...
variable "os_write_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-OS-WRITE-LOG"
}
...
variable "os_read_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-OS-READ-LOG"
}
...
variable "vss_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-VSS-LOG"
}
...
variable "waf_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-WAF-LOG"
}
...
variable "event_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-EVENT-LOG"
}
...
variable "firewall_threat_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-NFW-THREAT-LOG"
}
...
variable "firewall_traffic_log_name" {
  ...
  default     = "OCI-SCCA-LZ-CHILD-NFW-TRAFFIC-LOG"
}
...
variable "backup_bucket_name" {
  type        = string
  default     = "OCI-SCCA-LZ-CHILD-BACKUP"
...
variable "parent_namespace" {
  type        = string
  default     = ""
  description = "The Object Storage Namespace of Parent Tenancy."
}
...
variable "scca_parent_logging_compartment_ocid" {
  type        = string
  description = "Parent Template Logging Compartment OCID value."
  default     = ""
}
...
variable "activate_service_connectors" {
  type        = bool
  default     = true
  description = "Set to true to activate service connectors on creation, set to false to make service connectors inactive on creation"
  validation {
...
variable "parent_resource_label" {
  type        = string
  default     = ""
  description = "Resource label from the parent tenancy"
}