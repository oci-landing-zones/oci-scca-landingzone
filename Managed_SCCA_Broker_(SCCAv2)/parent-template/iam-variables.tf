...
variable "child_tenancy_ocid" {
  type        = string
  default     = ""
  description = "The tenancy OCID of child template"
}

variable "child_admin_group_ocid" {
  type        = string
  default     = ""
  description = "The child admin group OCID of child template"
}

variable "child_system_admin_group_ocid" {
  type        = string
  default     = ""
  description = "The system admin group OCID of child template"
}

variable "child_vdms_compartment_ocid" {
  type        = string
  default     = ""
  description = "The VDMS compartment OCID of child template"
}
